...
define("EW_PROJECT_NAME", "ferryman", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{D49A959E-F136-47C9-B9D7-6B34755F62D4}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'XISnfampLM0C3ztX', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/ferryman.css", TRUE); // Project stylesheet file name
...
$EW_JAVASCRIPT_FILES[] = "bower_components/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js";

// External StyleSheets
$EW_STYLESHEET_FILES = array();
$EW_STYLESHEET_FILES[] = "bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css";
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "ferryman", "qs" => "`", "qe" => "`");
$EW_CONN[0] = &$EW_CONN["DB"];
$EW_CONN["ferryman1"] = array("conn" => NULL, "id" => "ferryman1", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "ferryman", "qs" => "`", "qe" => "`", "new" => TRUE);
$EW_CONN[1] = &$EW_CONN["ferryman1"];
...
define("EW_USER_TABLE", "`admin`", TRUE);
