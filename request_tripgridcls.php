<?php include_once "request_tripinfo.php" ?>
...
$request_trip_grid = NULL; // Initialize page object first

class crequest_trip_grid extends crequest_trip {
	...
	// Table name
	var $TableName = 'request_trip';

	// Page object name
	var $PageObjName = 'request_trip_grid';

	// Grid form hidden field names
	var $FormName = 'frequest_tripgrid';
	...
	function __construct() {
		...
		if (!isset($GLOBALS["request_trip"]) || get_class($GLOBALS["request_trip"]) == "crequest_trip") {
			$GLOBALS["request_trip"] = &$this;

//			$GLOBALS["MasterTable"] = &$GLOBALS["Table"];
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["request_trip"];
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'request_trip', TRUE);
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function RenderRow() {
		...
		$sSqlWrk = "SELECT `id`, `name` AS `DispFld`, '' AS `Disp2Fld`, '' AS `Disp3Fld`, '' AS `Disp4Fld` FROM `category`";
		$sWhereWrk = "";
		...
		$this->category->ViewCustomAttributes = "";
			...
			$sSqlWrk = "SELECT `id`, `name` AS `DispFld`, '' AS `Disp2Fld`, '' AS `Disp3Fld`, '' AS `Disp4Fld`, '' AS `SelectFilterFld`, '' AS `SelectFilterFld2`, '' AS `SelectFilterFld3`, '' AS `SelectFilterFld4` FROM `category`";
			$sWhereWrk = "";
			$this->category->LookupFilters = array();
			ew_AddFilter($sWhereWrk, $sFilterWrk);
			$this->Lookup_Selecting($this->category, $sWhereWrk); // Call Lookup Selecting
	...
	function SetupLookupFilters($fld, $pageId = null) {
		...
		case "x_category":
			$sSqlWrk = "";
			$sSqlWrk = "SELECT `id` AS `LinkFld`, `name` AS `DispFld`, '' AS `Disp2Fld`, '' AS `Disp3Fld`, '' AS `Disp4Fld` FROM `category`";
			$sWhereWrk = "";
