...
// Page class
//
class mobile_confirm_code_delete extends mobile_confirm_code
{
	...
	// Page object name
	public $PageObjName = "mobile_confirm_code_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("mobile_confirm_codelist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("mobile_confirm_codelist.php"); // Return to list
			}
		}
	}
