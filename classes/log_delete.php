...
class log_delete extends log
{
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("loglist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("loglist.php"); // Return to list
			}
		}
	}
