...
// Page class
//
class admin_search extends admin
{
	...
	// Page object name
	public $PageObjName = "admin_search";
	...
	protected function validateSearch()
	{
		...
		if (!CheckInteger($this->locked->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->locked->errorMessage());
		}
