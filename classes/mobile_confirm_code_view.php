...
// Page class
//
class mobile_confirm_code_view extends mobile_confirm_code
{
	...
	// Page object name
	public $PageObjName = "mobile_confirm_code_view";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("mobile_confirm_codelist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->terminate("mobile_confirm_codelist.php"); // Return to list page
					...
					if (!$matchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$returnUrl = "mobile_confirm_codelist.php"; // No matching record, return to list
					} else {
			...
			$returnUrl = "mobile_confirm_codelist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "")
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("mobile_confirm_codelist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
