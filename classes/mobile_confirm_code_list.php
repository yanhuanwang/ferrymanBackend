...
// Page class
//
class mobile_confirm_code_list extends mobile_confirm_code
{
	...
	// Table name
	public $TableName = 'mobile_confirm_code';

	// Page object name
	public $PageObjName = "mobile_confirm_code_list";

	// Grid form hidden field names
	public $FormName = "fmobile_confirm_codelist";
	...
	public function __construct()
	{
		...
		// Table object (mobile_confirm_code)
		if (!isset($GLOBALS["mobile_confirm_code"]) || get_class($GLOBALS["mobile_confirm_code"]) == PROJECT_NAMESPACE . "mobile_confirm_code") {
			$GLOBALS["mobile_confirm_code"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["mobile_confirm_code"];
		}
		...
		$this->AddUrl = "mobile_confirm_codeadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "mobile_confirm_codedelete.php";
		$this->MultiUpdateUrl = "mobile_confirm_codeupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'mobile_confirm_code');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fmobile_confirm_codelistsrch";
	...
	public function terminate($url = "")
	{
		...
		// Export
		global $EXPORT, $mobile_confirm_code;
		if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, $EXPORT)) {
			...
			if (class_exists($class)) {
				$doc = new $class($mobile_confirm_code);
				$doc->Text = @$content;
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fmobile_confirm_codelistsrch", $filters);
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fmobile_confirm_codelistsrch\" href=\"#\">" . $Language->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fmobile_confirm_codelistsrch\" href=\"#\">" . $Language->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fmobile_confirm_codelist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->Phrase("SearchPanel") . "\" data-caption=\"" . $Language->Phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fmobile_confirm_codelistsrch\">" . $Language->Phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
	...
	protected function setupExportOptions()
	{
		...
		$url = "";
		$item->Body = "<button id=\"emf_mobile_confirm_code\" class=\"ew-export-link ew-email\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew.emailDialogShow({lnk:'emf_mobile_confirm_code',hdr:ew.language.phrase('ExportToEmailText'),f:document.fmobile_confirm_codelist,sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
