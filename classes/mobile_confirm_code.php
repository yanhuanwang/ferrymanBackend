...
/**
 * Table class for mobile_confirm_code
 */
class mobile_confirm_code extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'mobile_confirm_code';
		$this->TableName = 'mobile_confirm_code';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`mobile_confirm_code`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('mobile_confirm_code', 'mobile_confirm_code', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// mobile_phone
		$this->mobile_phone = new DbField('mobile_confirm_code', 'mobile_confirm_code', 'x_mobile_phone', 'mobile_phone', '`mobile_phone`', '`mobile_phone`', 200, -1, FALSE, '`mobile_phone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mobile_phone->Nullable = FALSE; // NOT NULL field
		$this->mobile_phone->Required = TRUE; // Required field
		$this->mobile_phone->Sortable = TRUE; // Allow sort
		$this->fields['mobile_phone'] = &$this->mobile_phone;

		// code
		$this->code = new DbField('mobile_confirm_code', 'mobile_confirm_code', 'x_code', 'code', '`code`', '`code`', 200, -1, FALSE, '`code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->code->Sortable = TRUE; // Allow sort
		$this->fields['code'] = &$this->code;

		// createdAt
		$this->createdAt = new DbField('mobile_confirm_code', 'mobile_confirm_code', 'x_createdAt', 'createdAt', '`createdAt`', CastDateFieldForLike('`createdAt`', 0, "DB"), 135, 0, FALSE, '`createdAt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// updatedAt
		$this->updatedAt = new DbField('mobile_confirm_code', 'mobile_confirm_code', 'x_updatedAt', 'updatedAt', '`updatedAt`', CastDateFieldForLike('`updatedAt`', 0, "DB"), 135, 0, FALSE, '`updatedAt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`mobile_confirm_code`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "mobile_confirm_codelist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "mobile_confirm_codeview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "mobile_confirm_codeedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "mobile_confirm_codeadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("mobile_confirm_codeview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("mobile_confirm_codeview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "mobile_confirm_codeadd.php?" . $this->getUrlParm($parm);
		else
			$url = "mobile_confirm_codeadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("mobile_confirm_codeedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("mobile_confirm_codeadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("mobile_confirm_codedelete.php", $this->getUrlParm());
	}
