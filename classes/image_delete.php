...
// Page class
//
class image_delete extends image
{
	...
	// Page object name
	public $PageObjName = "image_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("imagelist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("imagelist.php"); // Return to list
			}
		}
	}
