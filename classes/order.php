...
class order extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('order', 'order', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// user_id
		$this->user_id = new DbField('order', 'order', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 3, -1, FALSE, '`user_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		switch ($CurrentLanguage) {
			case "en":
				$this->user_id->Lookup = new Lookup('user_id', 'user', FALSE, 'id', ["username","","",""], [], [], [], [], [], '', '');
				break;
			default:
				$this->user_id->Lookup = new Lookup('user_id', 'user', FALSE, 'id', ["username","","",""], [], [], [], [], [], '', '');
				break;
		...
		// from_place
		$this->from_place = new DbField('order', 'order', 'x_from_place', 'from_place', '`from_place`', '`from_place`', 200, -1, FALSE, '`from_place`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// to_place
		$this->to_place = new DbField('order', 'order', 'x_to_place', 'to_place', '`to_place`', '`to_place`', 200, -1, FALSE, '`to_place`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// date
		$this->date = new DbField('order', 'order', 'x_date', 'date', '`date`', CastDateFieldForLike('`date`', 0, "DB"), 135, 0, FALSE, '`date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// flight_number
		$this->flight_number = new DbField('order', 'order', 'x_flight_number', 'flight_number', '`flight_number`', '`flight_number`', 200, -1, FALSE, '`flight_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->flight_number->Sortable = TRUE; // Allow sort
		$this->fields['flight_number'] = &$this->flight_number;

		// description
		$this->description = new DbField('order', 'order', 'x_description', 'description', '`description`', '`description`', 200, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->description->Sortable = TRUE; // Allow sort
		$this->fields['description'] = &$this->description;

		// createdAt
		$this->createdAt = new DbField('order', 'order', 'x_createdAt', 'createdAt', '`createdAt`', CastDateFieldForLike('`createdAt`', 0, "DB"), 135, 0, FALSE, '`createdAt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// updatedAt
		$this->updatedAt = new DbField('order', 'order', 'x_updatedAt', 'updatedAt', '`updatedAt`', CastDateFieldForLike('`updatedAt`', 0, "DB"), 135, 0, FALSE, '`updatedAt`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "orderedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "orderadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("orderview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("orderview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "orderadd.php?" . $this->getUrlParm($parm);
		else
			$url = "orderadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("orderedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("orderadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("orderdelete.php", $this->getUrlParm());
	}
