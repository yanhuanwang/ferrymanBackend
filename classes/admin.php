...
class admin extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('admin', 'admin', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// username
		$this->username = new DbField('admin', 'admin', 'x_username', 'username', '`username`', '`username`', 200, -1, FALSE, '`username`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// level
		$this->level = new DbField('admin', 'admin', 'x_level', 'level', '`level`', '`level`', 3, -1, FALSE, '`level`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// locked
		$this->locked = new DbField('admin', 'admin', 'x_locked', 'locked', '`locked`', '`locked`', 16, -1, FALSE, '`locked`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// email
		$this->_email = new DbField('admin', 'admin', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// activated
		$this->activated = new DbField('admin', 'admin', 'x_activated', 'activated', '`activated`', '`activated`', 16, -1, FALSE, '`activated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`admin`";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "adminedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "adminadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("adminview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("adminview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "adminadd.php?" . $this->getUrlParm($parm);
		else
			$url = "adminadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("adminedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("adminadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("admindelete.php", $this->getUrlParm());
	}
