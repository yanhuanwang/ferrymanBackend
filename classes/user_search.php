...
class user_search extends user
{
	...
	// Page object name
	public $PageObjName = "user_search";
	...
	protected function buildAdvancedSearch()
	{
		...
		$this->buildSearchUrl($srchUrl, $this->nickname); // nickname
	...
	protected function loadSearchValues()
	{
		...
		// photo
		$this->photo->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_photo"));
		$this->photo->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_photo"));

		// nickname
		$this->nickname->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_nickname"));
		$this->nickname->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_nickname"));
		...
		// locked
		$this->locked->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_locked"));
		$this->locked->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_locked"));

		// send_role
		$this->send_role->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_send_role"));
		$this->send_role->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_send_role"));

		// carrier_role
		$this->carrier_role->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_carrier_role"));
		$this->carrier_role->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_carrier_role"));
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->nickname->EditValue = HtmlEncode($this->nickname->AdvancedSearch->SearchValue);
