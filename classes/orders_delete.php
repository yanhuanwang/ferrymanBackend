...
// Page class
//
class orders_delete extends orders
{
	...
	// Page object name
	public $PageObjName = "orders_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("orderslist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("orderslist.php"); // Return to list
			}
		}
	}
