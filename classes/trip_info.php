 ...
 */
class trip_info extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('trip_info', 'trip_info', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// from_place
		$this->from_place = new DbField('trip_info', 'trip_info', 'x_from_place', 'from_place', '`from_place`', '`from_place`', 200, -1, FALSE, '`from_place`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// to_place
		$this->to_place = new DbField('trip_info', 'trip_info', 'x_to_place', 'to_place', '`to_place`', '`to_place`', 200, -1, FALSE, '`to_place`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// user_id
		$this->user_id = new DbField('trip_info', 'trip_info', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 3, -1, FALSE, '`user_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// flight_number
		$this->flight_number = new DbField('trip_info', 'trip_info', 'x_flight_number', 'flight_number', '`flight_number`', '`flight_number`', 200, -1, FALSE, '`flight_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->flight_number->Nullable = FALSE; // NOT NULL field
		$this->flight_number->Required = TRUE; // Required field
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`trip_info`";
	}
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("trip_infoview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("trip_infoview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "trip_infoadd.php?" . $this->getUrlParm($parm);
		else
	...
	{
		$url = $this->keyUrl("trip_infoedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("trip_infoadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("trip_infodelete.php", $this->getUrlParm());
	}
