...
// Page class
//
class mobile_confirm_code_add extends mobile_confirm_code
{
	...
	// Page object name
	public $PageObjName = "mobile_confirm_code_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("mobile_confirm_codelist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "mobile_confirm_codelist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "mobile_confirm_codeview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// mobile_phone
		$this->mobile_phone->setDbValueDef($rsnew, $this->mobile_phone->CurrentValue, "", FALSE);
