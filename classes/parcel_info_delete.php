...
// Page class
//
class parcel_info_delete extends parcel_info
{
	...
	// Page object name
	public $PageObjName = "parcel_info_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("parcel_infolist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("parcel_infolist.php"); // Return to list
			}
		}
	}
