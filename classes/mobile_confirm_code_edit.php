...
// Page class
//
class mobile_confirm_code_edit extends mobile_confirm_code
{
	...
	// Page object name
	public $PageObjName = "mobile_confirm_code_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// mobile_phone
			$this->mobile_phone->setDbValueDef($rsnew, $this->mobile_phone->CurrentValue, "", $this->mobile_phone->ReadOnly);
