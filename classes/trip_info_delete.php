...
// Page class
//
class trip_info_delete extends trip_info
{
	...
	// Page object name
	public $PageObjName = "trip_info_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("trip_infolist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("trip_infolist.php"); // Return to list
			}
		}
	}
