...
// Page class
//
class orders_view extends orders
{
	...
	// Page object name
	public $PageObjName = "orders_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$matchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$returnUrl = "orderslist.php"; // No matching record, return to list
					} else {
			...
			$returnUrl = "orderslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "")
