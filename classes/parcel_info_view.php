...
// Page class
//
class parcel_info_view extends parcel_info
{
	...
	// Page object name
	public $PageObjName = "parcel_info_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$matchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$returnUrl = "parcel_infolist.php"; // No matching record, return to list
					} else {
			...
			$returnUrl = "parcel_infolist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "")
