...
class category extends DbTable
{
	...
	public function __construct()
	{
		...
		// description
		$this->description = new DbField('category', 'category', 'x_description', 'description', '`description`', '`description`', 200, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
