...
// Page class
//
class order_grid extends order
{
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["order"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// flight_number
			$this->flight_number->setDbValueDef($rsnew, $this->flight_number->CurrentValue, NULL, $this->flight_number->ReadOnly);
