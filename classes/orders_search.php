...
class orders_search extends orders
{
	...
	// Page object name
	public $PageObjName = "orders_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr <> "") {
					...
					$srchStr = "orderslist.php" . "?" . $srchStr;
	...
	protected function buildAdvancedSearch()
	{
		...
		$this->buildSearchUrl($srchUrl, $this->parcel_id); // parcel_id
		$this->buildSearchUrl($srchUrl, $this->carrier_id); // carrier_id
	...
	protected function loadSearchValues()
	{
		...
		// parcel_id
		$this->parcel_id->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_parcel_id"));
		$this->parcel_id->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_parcel_id"));

		// carrier_id
		$this->carrier_id->AdvancedSearch->setSearchValue($CurrentForm->getValue("x_carrier_id"));
		$this->carrier_id->AdvancedSearch->setSearchOperator($CurrentForm->getValue("z_carrier_id"));
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->parcel_id->EditValue = HtmlEncode($this->parcel_id->AdvancedSearch->SearchValue);
			$curVal = strval($this->parcel_id->AdvancedSearch->SearchValue);
			if ($curVal <> "") {
			...
			$this->carrier_id->EditValue = HtmlEncode($this->carrier_id->AdvancedSearch->SearchValue);
			$curVal = strval($this->carrier_id->AdvancedSearch->SearchValue);
			if ($curVal <> "") {
	...
	protected function validateSearch()
	{
		...
		if (!CheckInteger($this->parcel_id->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->parcel_id->errorMessage());
		}
		if (!CheckInteger($this->carrier_id->AdvancedSearch->SearchValue)) {
			AddMessage($SearchError, $this->carrier_id->errorMessage());
		}
