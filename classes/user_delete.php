...
// Page class
//
class user_delete extends user
{
	...
	// Page object name
	public $PageObjName = "user_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("userlist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("userlist.php"); // Return to list
			}
		}
	}
