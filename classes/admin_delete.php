...
// Page class
//
class admin_delete extends admin
{
	...
	// Page object name
	public $PageObjName = "admin_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("adminlist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("adminlist.php"); // Return to list
			}
		}
	}
