...
// Create page object
$parcel_info_edit = new parcel_info_edit();

// Run the page
$parcel_info_edit->run();
...
var fparcel_infoedit = currentForm = new ew.Form("fparcel_infoedit", "edit");

// Validate form
fparcel_infoedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($parcel_info_edit->id->Required) { ?>
			elm = this.getElements("x" + infix + "_id");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $parcel_info->id->caption(), $parcel_info->id->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($parcel_info_edit->from_place->Required) { ?>
		...
		<?php } ?>
		<?php if ($parcel_info_edit->to_place->Required) { ?>
		...
		<?php } ?>
		<?php if ($parcel_info_edit->description->Required) { ?>
		...
		<?php } ?>
		<?php if ($parcel_info_edit->user_id->Required) { ?>
		...
		<?php if ($parcel_info_edit->name->Required) { ?>
...
fparcel_infoedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fparcel_infoedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $parcel_info_edit->showPageHeader(); ?>
<?php
$parcel_info_edit->showMessage();
?>
<?php if (!$parcel_info_edit->IsModal) { ?>
<?php if (!$parcel_info->isConfirm()) { // Confirm page ?>
<form name="ew-pager-form" class="form-inline ew-form ew-pager-form" action="<?php echo CurrentPageName() ?>">
<?php if (!isset($parcel_info_edit->Pager)) $parcel_info_edit->Pager = new NumericPager($parcel_info_edit->StartRec, $parcel_info_edit->DisplayRecs, $parcel_info_edit->TotalRecs, $parcel_info_edit->RecRange, $parcel_info_edit->AutoHidePager) ?>
<?php if ($parcel_info_edit->Pager->RecordCount > 0 && $parcel_info_edit->Pager->Visible) { ?>
<div class="ew-pager">
<div class="ew-numeric-page"><ul class="pagination">
	<?php if ($parcel_info_edit->Pager->FirstButton->Enabled) { ?>
	<li class="page-item"><a class="page-link" href="<?php echo $parcel_info_edit->pageUrl() ?>start=<?php echo $parcel_info_edit->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($parcel_info_edit->Pager->PrevButton->Enabled) { ?>
	<li class="page-item"><a class="page-link" href="<?php echo $parcel_info_edit->pageUrl() ?>start=<?php echo $parcel_info_edit->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($parcel_info_edit->Pager->Items as $pagerItem) { ?>
		<li class="page-item<?php if (!$pagerItem->Enabled) { ?> active<?php } ?>"><a class="page-link" href="<?php if ($pagerItem->Enabled) { echo $parcel_info_edit->pageUrl() . "start=" . $pagerItem->Start; } else { echo "#"; } ?>"><?php echo $pagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($parcel_info_edit->Pager->NextButton->Enabled) { ?>
	<li class="page-item"><a class="page-link" href="<?php echo $parcel_info_edit->pageUrl() ?>start=<?php echo $parcel_info_edit->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($parcel_info_edit->Pager->LastButton->Enabled) { ?>
	<li class="page-item"><a class="page-link" href="<?php echo $parcel_info_edit->pageUrl() ?>start=<?php echo $parcel_info_edit->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</div>
<?php } ?>
...
<?php } ?>
<?php } ?>
<form name="fparcel_infoedit" id="fparcel_infoedit" class="<?php echo $parcel_info_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($parcel_info_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $parcel_info_edit->Token ?>">
<?php } ?>
...
<?php } ?>
<input type="hidden" name="modal" value="<?php echo (int)$parcel_info_edit->IsModal ?>">
...
<?php if ($parcel_info->id->Visible) { // id ?>
	<div id="r_id" class="form-group row">
		<label id="elh_parcel_info_id" class="<?php echo $parcel_info_edit->LeftColumnClass ?>"><?php echo $parcel_info->id->caption() ?><?php echo ($parcel_info->id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $parcel_info_edit->RightColumnClass ?>"><div<?php echo $parcel_info->id->cellAttributes() ?>>
<?php if (!$parcel_info->isConfirm()) { ?>
<span id="el_parcel_info_id">
<span<?php echo $parcel_info->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($parcel_info->id->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="parcel_info" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($parcel_info->id->CurrentValue) ?>">
<?php } else { ?>
<span id="el_parcel_info_id">
<span<?php echo $parcel_info->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($parcel_info->id->ViewValue) ?>"></span>
</span>
<input type="hidden" data-table="parcel_info" data-field="x_id" name="x_id" id="x_id" value="<?php echo HtmlEncode($parcel_info->id->FormValue) ?>">
<?php } ?>
<?php echo $parcel_info->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($parcel_info->from_place->Visible) { // from_place ?>
	<div id="r_from_place" class="form-group row">
		<label id="elh_parcel_info_from_place" for="x_from_place" class="<?php echo $parcel_info_edit->LeftColumnClass ?>"><?php echo $parcel_info->from_place->caption() ?><?php echo ($parcel_info->from_place->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $parcel_info_edit->RightColumnClass ?>"><div<?php echo $parcel_info->from_place->cellAttributes() ?>>
<?php if (!$parcel_info->isConfirm()) { ?>
...
<?php if ($parcel_info->to_place->Visible) { // to_place ?>
	<div id="r_to_place" class="form-group row">
		<label id="elh_parcel_info_to_place" for="x_to_place" class="<?php echo $parcel_info_edit->LeftColumnClass ?>"><?php echo $parcel_info->to_place->caption() ?><?php echo ($parcel_info->to_place->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $parcel_info_edit->RightColumnClass ?>"><div<?php echo $parcel_info->to_place->cellAttributes() ?>>
<?php if (!$parcel_info->isConfirm()) { ?>
...
<?php if ($parcel_info->description->Visible) { // description ?>
	<div id="r_description" class="form-group row">
		<label id="elh_parcel_info_description" for="x_description" class="<?php echo $parcel_info_edit->LeftColumnClass ?>"><?php echo $parcel_info->description->caption() ?><?php echo ($parcel_info->description->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $parcel_info_edit->RightColumnClass ?>"><div<?php echo $parcel_info->description->cellAttributes() ?>>
<?php if (!$parcel_info->isConfirm()) { ?>
...
<?php if ($parcel_info->user_id->Visible) { // user_id ?>
	<div id="r_user_id" class="form-group row">
		<label id="elh_parcel_info_user_id" class="<?php echo $parcel_info_edit->LeftColumnClass ?>"><?php echo $parcel_info->user_id->caption() ?><?php echo ($parcel_info->user_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $parcel_info_edit->RightColumnClass ?>"><div<?php echo $parcel_info->user_id->cellAttributes() ?>>
<?php if (!$parcel_info->isConfirm()) { ?>
...
<script>
fparcel_infoedit.createAutoSuggest({"id":"x_user_id","forceSelect":false});
</script>
</span>
<?php } ?>
<?php } else { ?>
...
<?php if ($parcel_info->image_id->Visible) { // image_id ?>
	<div id="r_image_id" class="form-group row">
		...
		<div class="<?php echo $parcel_info_edit->RightColumnClass ?>"><div<?php echo $parcel_info->image_id->cellAttributes() ?>>
<?php if (!$parcel_info->isConfirm()) { ?>
...
<script>
fparcel_infoedit.createAutoSuggest({"id":"x_image_id","forceSelect":false});
</script>
</span>
<?php } ?>
<?php } else { ?>
...
<?php if ($parcel_info->name->Visible) { // name ?>
	<div id="r_name" class="form-group row">
		<label id="elh_parcel_info_name" for="x_name" class="<?php echo $parcel_info_edit->LeftColumnClass ?>"><?php echo $parcel_info->name->caption() ?><?php echo ($parcel_info->name->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $parcel_info_edit->RightColumnClass ?>"><div<?php echo $parcel_info->name->cellAttributes() ?>>
<?php if (!$parcel_info->isConfirm()) { ?>
...
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $parcel_info_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
<?php } else { ?>
...
<?php
$parcel_info_edit->showPageFooter();
if (DEBUG_ENABLED)
