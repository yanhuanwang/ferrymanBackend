...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "15.0.0");
...
define(PROJECT_NAMESPACE . "USER_TABLE_NAME", "admin");
...
define(PROJECT_NAMESPACE . "USER_TABLE", "`admin`");
...
define(PROJECT_NAMESPACE . "UPLOAD_DEST_PATH", "uploads/"); // Upload destination path (relative to app root)
